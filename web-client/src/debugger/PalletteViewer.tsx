...
export function PalletteViewer({ ppu }: { ppu: Ppu; }) {
    ...
    bg-[#503000] bg-[#007800] bg-[#006800] bg-[#005800] bg-[#004058] bg-[#000000] bg-[#000000] bg-[#000000]
    bg-[#BCBCBC] bg-[#0078F8] bg-[#0058F8] bg-[#6844FC] bg-[#D800CC] bg-[#E40058] bg-[#F83800] bg-[#E45C10]
    bg-[#AC7C00] bg-[#00B800] bg-[#00A800] bg-[#00A844] bg-[#008888] bg-[#000000] bg-[#000000] bg-[#000000]
    bg-[#F8F8F8] bg-[#3CBCFC] bg-[#6888FC] bg-[#9878F8] bg-[#F878F8] bg-[#F85898] bg-[#F87858] bg-[#FCA044]
    bg-[#F8B800] bg-[#B8F818] bg-[#58D854] bg-[#58F898] bg-[#00E8D8] bg-[#787878] bg-[#000000] bg-[#000000]
    bg-[#FCFCFC] bg-[#A4E4FC] bg-[#B8B8F8] bg-[#D8B8F8] bg-[#F8B8F8] bg-[#F8A4C0] bg-[#F0D0B0] bg-[#FCE0A8]
    bg-[#F8D878] bg-[#D8F878] bg-[#B8F8B8] bg-[#B8F8D8] bg-[#00FCFC] bg-[#F8D8F8] bg-[#000000] bg-[#000000]"></div>;
    const pallettes = [];
