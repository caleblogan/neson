...
const offscreenCanvas = new OffscreenCanvas(256 * 2, 240 * 2)

const cart = new Cart0(prgRom, chrRom)
const ppu = new Ppu(cart, offscreenCanvas)
const apu = new Apu()
...
setInterval(() => {
  ...
  ctx.drawImage(offscreenCanvas, 0, 0, 256 * 2, 240 * 2)
}, 16.6667)
...
function App() {
  ...
  useEffect(() => {
    let systemClock = 0
    const BATCH_CYCLES = 2 ** 15 + 15_000
